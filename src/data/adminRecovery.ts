...
const WORD_LIST = [
  ...
  "academic", "access", "accident", "account", "achieve", "acid", "acoustic",
  "acquire", "across", "act", "action", "actor", "active", "adapt", "add",
  "adjust", "advance", "adult", "advise", "aerobic", "affair", "afford",
  "afraid", "again", "age", "agent", "agree", "ahead", "aim", "air", "alarm",
  "album", "alert", "alien", "all", "alley", "allow", "almost", "alone",
  "alpha", "already", "also", "alter", "always", "analyst", "anchor", "animal",
  ...
  "arrest", "arrive", "arrow", "art", "article", "artist", "ask", "aspect",
  ...
  "awesome", "awful", "awkward", "axiom", "axis", "bachelor", "back", "bacon",
  ...
  "chunk", "churn", "cigar", "cinnamon", "circle", "citizen", "civic", "civil",
  ...
  "color", "column", "combine", "come", "comfort", "comic", "commit", "common",
  ...
  "daring", "dark", "dash", "data", "date", "daughter", "dawn", "day", "deal",
  ...
  "expand", "expect", "expire", "explain", "expose", "extend", "extra", "extreme",
  "eye", "fabric", "face", "faculty", "fade", "faint", "faith", "fall", "false",
  ...
  "focus", "fog", "foil", "fold", "follow", "food", "foot", "force", "foreign",
  "forest", "forget", "form", "fortune", "forward", "fossil", "foster", "found",
  ...
  "know", "koala", "label", "labor", "ladder", "lady", "lake", "lamp", "language",
  ...
  "occur", "ocean", "october", "odor", "off", "offend", "offer", "office", "often",
  ...
  "place", "planet", "plastic", "plate", "play", "player", "please", "pledge",
  ...
  "rescue", "resign", "resist", "resource", "response", "result", "retire", "retreat",
  "return", "reunion", "reveal", "review", "reward", "rhythm", "rib", "ribbon",
  "rice", "rich", "ride", "ridge", "rifle", "right", "rigid", "ring", "riot",
  "rip", "ripe", "rise", "risk", "rival", "river", "road", "roast", "robot",
  ...
  "space", "spare", "spatial", "spawn", "speak", "special", "speed", "spell", "spend",
  "sphere", "spice", "spider", "spike", "spin", "spirit", "split", "spoil", "sponsor",
  "spoon", "sport", "spot", "spray", "spread", "spring", "spy", "square", "squeeze",
  ...
  "swiss", "switch", "sword", "symbol", "symptom", "syrup", "system", "table", "tackle",
